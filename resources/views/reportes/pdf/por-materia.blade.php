        ...
        <table>
            <tr>
                <td style="width: 50%;">
                    ...
                    <p class="report-title">Reporte de Rendimiento por Materia</p>
                </td>
